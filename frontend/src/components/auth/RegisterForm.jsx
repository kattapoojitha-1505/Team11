      ...
      <form onSubmit={handleSubmit} className="space-y-5 text-left">
        <div>
          ...
          <input
            ...
            className="w-full bg-[#111827]/40 border border-gray-900 rounded-xl px-4 py-3.5 text-sm text-gray-100 placeholder-gray-650 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all duration-200"
            required
          />
        </div>
        ...
        >
          {submitting ? (
            ...
            <span>Create Developer Node</span>
          )}
        </button>
      </form>

      <div className="text-center text-xs text-gray-500 pt-4">
        <span>Already possess a node? </span>
